...
| 영역 | 항목 |
|------|------|
| 의뢰 정보 (개발 PL) | 인증종류(Netflix NTS / Google xTS / Amazon AVTS), Test type(IR/LR/MR/파생), Test 목적(3PL/Official/Pre-Test/양산/self/MR), 진행차수(자동 산출·수정 가능), 모델명(드롭다운+직접입력), FW 버전, 의뢰자(드롭다운+직접입력), 희망일정, 비고 |
